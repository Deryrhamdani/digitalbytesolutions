            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative h-100">
                        ...
                        <div class="service-btn rounded-0 rounded-bottom">
                            <a class="text-dark fw-medium" href="web-profile">Selengkapnya<i class="bi bi-chevron-double-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item position-relative h-100">
                        ...
                        <div class="service-btn rounded-0 rounded-bottom">
                            <a class="text-dark fw-medium" href="web-aplikasi">Selengkapnya<i class="bi bi-chevron-double-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item position-relative h-100">
                        ...
                        <div class="service-btn rounded-0 rounded-bottom">
                            <a class="text-dark fw-medium" href="mobile-app">Selengkapnya<i class="bi bi-chevron-double-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative h-100">
                        ...
                        <div class="service-btn rounded-0 rounded-bottom">
                            <a class="text-dark fw-medium" href="layanan-design">Selengkapnya<i class="bi bi-chevron-double-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>

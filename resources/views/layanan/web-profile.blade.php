                        ...
                        <div class="row g-4">
                            <div class="col-lg-4">
                                <div class="bg-light rounded">
                                    <div class="border-bottom p-4 mb-4">
                                        <h4 class="text-primary-gradient mb-1">Standar</h4>
                                        <span>Rekomendasi untuk Individual</span>
                                    </div>
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>100k<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Bulan</small>
                                        </h1>
                                        <div class="d-flex justify-content-between mb-3"><span>Detail Fitur</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <a href="" class=" btn animated-button text-white bg-dark rounded-pill py-2 px-4 mt-4">Pilih Paket</a>
                            ...
                            <div class="col-lg-4">
                                <div class="bg-light rounded border">
                                    <div class="border-bottom p-4 mb-4">
                                        <h4 class="text-primary-gradient mb-1">Bisnis</h4>
                                        <span>Rekomendasi untuk Organisasi</span>
                                    </div>
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>200k<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Bulan</small>
                                        </h1>
                                        <div class="d-flex justify-content-between mb-3"><span>Detail Fitur</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <a href="" class="btn animated-button text-white bg-dark rounded-pill py-2 px-4 mt-4">Pilih Paket</a>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="bg-light rounded">
                                    ...
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>300k<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Bulan</small>
                                        </h1>
                                        <div class="d-flex justify-content-between mb-3"><span>Detail Fitur</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <a href="" class="btn animated-button text-white bg-dark rounded-pill py-2 px-4 mt-4">Pilih Paket</a>
                                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-4">
                                <div class="bg-light rounded">
                                    ...
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>114.99<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Tahun</small>
                                        </h1>
                            ...
                            <div class="col-lg-4">
                                <div class="bg-light rounded border">
                                    ...
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>124.99<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Tahun</small>
                                        </h1>
                                        <div class="d-flex justify-content-between mb-3"><span>HTML5 & CSS3</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <div class="d-flex justify-content-between mb-3"><span>Bootstrap v5</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <div class="d-flex justify-content-between mb-3"><span>Responsive Layout</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                            ...
                            <div class="col-lg-4">
                                <div class="bg-light rounded">
                                    ...
                                    <div class="p-4 pt-0">
                                        <h1 class="mb-3">
                                            <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>134.99<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Tahun</small>
                                        </h1>
                                        <div class="d-flex justify-content-between mb-3"><span>HTML5 & CSS3</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <div class="d-flex justify-content-between mb-3"><span>Bootstrap v5</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        <div class="d-flex justify-content-between mb-3"><span>Responsive Layout</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>

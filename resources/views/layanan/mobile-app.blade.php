...
<body>
    ...
    <div class="container  wow fadeIn" data-wow-delay="0.1s">
        <img class="w-100" src="img/contents/image-mobile-app.png" alt="Image">
    </div>
    <!-- Page Header End -->
    <!-- Deskripsi Start -->
        ...
        <div class="container py-5 px-lg-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Mobile app (aplikasi seluler) adalah perangkat lunak yang dirancang khusus untuk dijalankan di perangkat seluler, seperti smartphone atau tablet. Mobile app dapat diunduh dan diinstal secara langsung ke perangkat melalui toko aplikasi seperti App Store untuk iOS atau Google Play Store untuk Android.</p>
                    <p class="mb-4">Aplikasi Mobile ini biasanya dirancang untuk memberikan pengalaman pengguna yang optimal pada perangkat mobile. Memiliki akses cepat serta mudah digunakan</p>

                </div>

                <div class="col-lg-5">
                    <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="img/icon/content-mobile-app.png">
                </div>
            </div>
        </div>
    </div>
